...
$("#r2tcModalFeat").click(function(){
  ...
  $("#modalBody").html("<p> Full-Stack using Node, express, MySql, and express-handlebars</p><p> Follows MVC architecture</p>  <p>Well modeled, connected collections in database.</p><p> User auth and email usage  </p><p>Display follows closely to state changes</p><p>App provides some pregenerated context but is mostly for user generated material (like facebook, twitter, instagram)</p>")
})
